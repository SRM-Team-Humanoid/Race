...
path = "/home/arpit/Humanoid/Race/race/scripts/"
print path+'data.xml'
...
balance = MotionSet(tree.parsexml("152 Balance"), offsets=[darwin,abmath_inv,new_hand])
...
l_step = MotionSet(tree2.parsexml("10 ff_l_r"), speed=1.5, offsets=[darwin,new_hand])
r_step = MotionSet(tree2.parsexml("9 ff_r_l"), speed=1.5, offsets=[darwin,new_hand])
...
r_turn = MotionSet(tree2.parsexml("27 RT"),speed=1.2,offsets=[darwin,new_hand])
l_turn = MotionSet(tree2.parsexml("28 LT"),speed=1.2,offsets=[darwin,new_hand])

fl1 = MotionSet(tree.parsexml("104 FLT_S_L"),speed=2.1,offsets=[darwin,new_hand])
fl2 = MotionSet(tree.parsexml("105 "),speed=2.1,offsets=[darwin,new_hand])
fl3 = MotionSet(tree.parsexml("110 FLT_M_R"),speed=2.7,offsets=[darwin,new_hand])
fl4 = MotionSet(tree.parsexml("111 "),speed=2.7,offsets=[darwin,new_hand])
fl5 = MotionSet(tree.parsexml("108 FLT_M_L"),speed=2.7,offsets=[darwin,new_hand])
fl6 = MotionSet(tree.parsexml("109 "),speed=2.7,offsets=[darwin,new_hand])

fl_init = Action([fl1,fl2])
fl_move = Action([fl3,fl4,fl5,fl6])
